  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // reset driver and tell we accept features
        SetDeviceStatus(VirtIOMMIODevices[j].Base, 0);
        SetDeviceStatus(VirtIOMMIODevices[j].Base, VIRTIO_ACKNOWLEDGE or VIRTIO_DRIVER);
        SetDeviceStatus(VirtIOMMIODevices[j].Base, VIRTIO_ACKNOWLEDGE or VIRTIO_DRIVER or VIRTIO_FEATURES_OK);
        ...
        VirtIOMMIODevices[j].QueueHandler := @VirtIOFSHandler;
